...
HOTKEY_OWNERSHIP_TASK_WEIGHT = int(os.getenv('HOTKEY_OWNERSHIP_TASK_WEIGHT', 0))
PREDICT_ALPHA_SELL_TASK_WEIGHT = int(os.getenv('PREDICT_ALPHA_SELL_TASK_WEIGHT', 100))
...
ENABLE_AWS_RDS_IAM = os.getenv('ENABLE_AWS_RDS_IAM', "0") == "1"